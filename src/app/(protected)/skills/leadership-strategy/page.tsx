    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-primary text-white p-6 rounded-lg mb-6">
          ...
          <p className="text-lg">Develop strategic leadership skills for guiding AI initiatives in your organization</p>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    5-10 minute learning bursts on strategic leadership for AI
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow h-full">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Apply your skills to realistic leadership & strategy scenarios
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
            <div className="flex items-start mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Practical leadership tasks to implement in your organization
                </p>
              </div>
            </div>
          </div>
