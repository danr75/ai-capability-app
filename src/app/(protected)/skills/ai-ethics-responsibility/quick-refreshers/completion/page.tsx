...
export default function CompletionPage() {
  ...
  const handleRedo = () => {
    ...
    setTimeout(() => {
      window.location.href = '/skills/ai-ethics-responsibility/quick-refreshers';
    }, 300);
  };
  ...
  const handleSave = () => {
    ...
    addSavedItem({
      title: 'Ethical Principles for Responsible AI',
      type: 'refresher',
      path: '/skills/ai-ethics-responsibility/quick-refreshers'
    });
  ...
  const isAlreadySaved = savedItems.some(item => 
    item.path === '/skills/ai-ethics-responsibility/quick-refreshers'
  );
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="max-w-7xl mx-auto pt-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Link 
            href="/skills/ai-ethics-responsibility"
          ...
          >
            ...
            Back to AI Ethics & Responsibility
          </Link>
          ...
          <div className="bg-[#2158F4] text-white rounded-lg p-4 sm:p-6 mb-6">
            ...
            <p className="mt-1">Lesson: Ethical Principles for Responsible AI</p>
          </div>
        </div>
      </div>
