...
export default function FoundationsEcosystemPage() {
  ...
  const modules = [
    ...
    { id: '4', title: 'Data Infrastructure', status: 'ready' as const, icon: 'lightning' as const, variant: 'purple' as const, href: '/skills/foundations-ecosystem/modules/4' },
    ...
    { id: '7', title: 'Ecosystem Design', status: 'done' as const, icon: 'check' as const },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-bold text-primary">Foundations & Ecosystem Capable</h1>
            <span className="bg-green-100 text-green-700 text-[11px] font-semibold px-2.5 py-0.5 rounded-full">● Excelling</span>
          </div>
        </div>
        ...
        <section className="bg-blue-50 rounded-lg shadow-sm p-6">
          ...
          {/* Speed Test */}
          <Link href="/speed-test-demo?capability=foundations-ecosystem" className="block">
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow h-full">
              <div className="flex items-start mb-4">
                <div className="bg-blue-100 p-3 rounded-full mr-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" viewBox="0 0 20 20" fill="currentColor">
          ...
          <Link href="/skills/foundations-ecosystem/lab-mode" className="block">
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow h-full">
              <div className="flex items-start mb-4">
