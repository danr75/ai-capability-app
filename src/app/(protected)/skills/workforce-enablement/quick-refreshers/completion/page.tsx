...
export default function CompletionPage() {
  ...
  const handleRedo = () => {
    ...
    setTimeout(() => {
      window.location.href = '/skills/workforce-enablement/quick-refreshers';
    }, 300);
  };
  ...
  const handleSave = () => {
    ...
    addSavedItem({
      title: 'Workforce Skills for the AI Era',
      type: 'refresher',
      path: '/skills/workforce-enablement/quick-refreshers'
    });
  ...
  const isAlreadySaved = savedItems.some(item => 
    item.path === '/skills/workforce-enablement/quick-refreshers'
  );
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="max-w-7xl mx-auto pt-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <Link 
            href="/skills/workforce-enablement"
          ...
          <div className="bg-[#2158F4] text-white rounded-lg p-4 sm:p-6 mb-6">
            ...
            <p className="mt-1">Lesson: Workforce Skills for the AI Era</p>
          </div>
        </div>
      </div>
